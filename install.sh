...
# "AzureChinaCloud" (https://mirror.azure.cn/docker-ce),and "TencentCloud" 
# (https://mirrors.cloud.tencent.com/docker-ce) for example:
#
...
case "$mirror" in
	...
	"")
		;;
	*)
		>&2 echo "unknown mirror '$mirror': use either 'Aliyun', or 'AzureChinaCloud', or'TencentCloud'."
		exit 1
		;;
esac
